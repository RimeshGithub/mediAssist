...
def initialize_symptom_predictor():
    ...
    try:
        ...
        df_causes_precautions = pd.read_csv(
            'datasets/disease_causes_precautions.csv')
...
def initialize_skin_predictor():
    ...
    try:
        skin_model = models.convnext_tiny(
        ...
        state_dict = torch.load(
            "models/skin_disease_classifier_model.pth", map_location=device)
...
def predict_symptom():
    ...
    try:
        ...
        recommended_doctor = get_doctor_recommendation(
...
if __name__ == '__main__':
    ...
    print("\nSystem Status:")
    print(
        f"  Symptom Model: {'✓ Loaded' if loaded_model is not None else '✗ Not loaded'}")
    print(
        f"  Skin Model: {'✓ Loaded' if skin_model is not None else '✗ Not loaded'}")
